import alooGobiRoti from './aloo-gobi-roti'
import appleAlmondButter from './apple-almond-butter'
import arabianChickenKabsaRice from './arabian-chicken-kabsa-rice'
...
import chineseStirFryVegRice from './chinese-stir-fry-veg-rice'
import coconutDalRice from './coconut-dal-rice'
import coconutWaterEggPumpkinSeeds from './coconut-water-egg-pumpkin-seeds'
import continentalGrilledSalmon from './continental-grilled-salmon'
import dalMakhaniRoti from './dal-makhani-roti'
import eggBhurjiParatha from './egg-bhurji-paratha'
import eggBhurjiParathaDinner from './egg-bhurji-paratha-dinner'
import eggCurryBrownRiceDinner from './egg-curry-brown-rice-dinner'
import eggCurryKeralaRice from './egg-curry-kerala-rice'
import eggKormaRice from './egg-korma-rice'
import egyptianGrilledFishRice from './egyptian-grilled-fish-rice'
import egyptianKoshariBowl from './egyptian-koshari-bowl'
import erisseryRice from './erissery-rice'
import falafelHummusPita from './falafel-hummus-pita'
import fennelWaterAmla from './fennel-water-amla'
import fishMoleeRice from './fish-molee-rice'
import fishPollichathuRice from './fish-pollichathu-rice'
import fishTacosWholeWheat from './fish-tacos-whole-wheat'
import frenchOmeletteHerbs from './french-omelette-herbs'
import gingerWaterAmla from './ginger-water-amla'
import greekBakedFishRoastedVeg from './greek-baked-fish-roasted-veg'
import greekChickenSouvlakiSalad from './greek-chicken-souvlaki-salad'
import greekLemonChickenPotatoes from './greek-lemon-chicken-potatoes'
import greekSaladBoiledEggs from './greek-salad-boiled-eggs'
...
import japaneseTeriyakiChickenRice from './japanese-teriyaki-chicken-rice'
import jeeraWaterAmla from './jeera-water-amla'
import kadalaCurryRice from './kadala-curry-rice'
import kalanRice from './kalan-rice'
import karimeenPollichathuRice from './karimeen-pollichathu-rice'
import keralaChickenCurryRice from './kerala-chicken-curry-rice'
import keralaEggRoast from './kerala-egg-roast'
import keralaFishCurry from './kerala-fish-curry'
import keralaSambarRice from './kerala-sambar-rice'
import koreanBibimbapEgg from './korean-bibimbap-egg'
import koreanDakgalbiRice from './korean-dakgalbi-rice'
import koreanDoenjangJjigae from './korean-doenjang-jjigae'
import lebaneseChickenFattoushBowl from './lebanese-chicken-fattoush-bowl'
import lebaneseFattoushEggs from './lebanese-fattoush-eggs'
import lebaneseGrilledChickenTabbouleh from './lebanese-grilled-chicken-tabbouleh'
import lebaneseLentilSoup from './lebanese-lentil-soup'
import lemonHoneyWater from './lemon-honey-water'
import lentilSoupBread from './lentil-soup-bread'
import mackerelCurryRice from './mackerel-curry-rice'
import malaysianVegCurryRice from './malaysian-veg-curry-rice'
import masalaScrambledEggsToast from './masala-scrambled-eggs-toast'
import matarPaneerRice from './matar-paneer-rice'
...
import mixVegCurryRice from './mix-veg-curry-rice'
import mixedNutsDarkChocolate from './mixed-nuts-dark-chocolate'
import moongSproutChaat from './moong-sprout-chaat'
import moroccanChickenTagineCouscous from './moroccan-chicken-tagine-couscous'
import moroccanChickpeaTagine from './moroccan-chickpea-tagine'
import moroccanSpicedFishQuinoa from './moroccan-spiced-fish-quinoa'
import murghMakhaniRoti from './murgh-makhani-roti'
import olanRice from './olan-rice'
import omeletteSpinachCheese from './omelette-spinach-cheese'
import palakPaneerRice from './palak-paneer-rice'
import panSearedFishBroccoli from './pan-seared-fish-broccoli'
import paneerBhurjiParathaLunch from './paneer-bhurji-paratha-lunch'
...
import spanishOmelette from './spanish-omelette'
import tamagoyaki from './tamagoyaki'
import tandooriChickenSalad from './tandoori-chicken-salad'
import thaiBasilChicken from './thai-basil-chicken'
import thaiBasilFriedRice from './thai-basil-fried-rice'
import thaiGreenCurryChickenRice from './thai-green-curry-chicken-rice'
import thoranRice from './thoran-rice'
import tibetanVegThukpa from './tibetan-veg-thukpa'
import tunaSaladWrap from './tuna-salad-wrap'
import turkishBakedFishVeg from './turkish-baked-fish-veg'
import turkishChickenShishRice from './turkish-chicken-shish-rice'
...
export const RECIPES = [
  ...
  chineseStirFryVegRice,
  coconutDalRice,
  coconutWaterEggPumpkinSeeds,
  continentalGrilledSalmon,
  dalMakhaniRoti,
  eggBhurjiParatha,
  eggBhurjiParathaDinner,
  eggCurryBrownRiceDinner,
  eggCurryKeralaRice,
  eggKormaRice,
  egyptianGrilledFishRice,
  egyptianKoshariBowl,
  erisseryRice,
  falafelHummusPita,
  fennelWaterAmla,
  ...
  frenchOmeletteHerbs,
  gingerWaterAmla,
  greekBakedFishRoastedVeg,
  greekChickenSouvlakiSalad,
  greekLemonChickenPotatoes,
  greekSaladBoiledEggs,
  ...
  japaneseTeriyakiChickenRice,
  jeeraWaterAmla,
  kadalaCurryRice,
  kalanRice,
  karimeenPollichathuRice,
  keralaChickenCurryRice,
  keralaEggRoast,
  keralaFishCurry,
  keralaSambarRice,
  koreanBibimbapEgg,
  koreanDakgalbiRice,
  koreanDoenjangJjigae,
  lebaneseChickenFattoushBowl,
  lebaneseFattoushEggs,
  lebaneseGrilledChickenTabbouleh,
  lebaneseLentilSoup,
  lemonHoneyWater,
  lentilSoupBread,
  mackerelCurryRice,
  malaysianVegCurryRice,
  masalaScrambledEggsToast,
  matarPaneerRice,
  ...
  minestroneSoupBread,
  mixVegCurryRice,
  mixedNutsDarkChocolate,
  moongSproutChaat,
  moroccanChickenTagineCouscous,
  moroccanChickpeaTagine,
  moroccanSpicedFishQuinoa,
  murghMakhaniRoti,
  olanRice,
  omeletteSpinachCheese,
  palakPaneerRice,
  panSearedFishBroccoli,
  paneerBhurjiParathaLunch,
  ...
  spanishOmelette,
  tamagoyaki,
  tandooriChickenSalad,
  thaiBasilChicken,
  thaiBasilFriedRice,
  thaiGreenCurryChickenRice,
  thoranRice,
  tibetanVegThukpa,
  tunaSaladWrap,
  turkishBakedFishVeg,
  turkishChickenShishRice,
  turkishEggsCilbir,
  turkishLentilSoup,
  turmericGoldenMilk,
  veggieFajitaBowl,
